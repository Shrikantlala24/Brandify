    ...
    <section className="w-full py-16 md:py-24 bg-gradient-to-r from-background via-background/95 to-background/90">
      <div className="container flex flex-col items-center text-center">
        ...
        <div className="mt-10 flex flex-col sm:flex-row gap-4 sm:gap-6">
          <Button className="bg-primary hover:bg-primary/90 text-white font-medium px-8 py-6 rounded-lg text-lg flex items-center gap-2 hover-lift hover:shadow-primary/20">
